...
.top-bar {
  ...
  gap: 14px;
  background: white;
  box-shadow: 0 8px 22px rgba(80, 40, 120, 0.08);
  color: #7b2cff;
}
...
.logo-circle {
  ...
  height: 38px;
  border-radius: 50%;
  background: radial-gradient(circle, #0f172a, #111827);
...
.quick-card {
  ...
  background: white;
  border-radius: 25px;
  box-shadow: 0 12px 25px rgba(80, 40, 120, 0.09);
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
.floating-button {
  ...
  color: white;
  box-shadow: 0 16px 28px rgba(123, 44, 255, 0.35);
}
...
.log-card {
  ...
  display: flex;
  align-items: center;
  box-shadow: 0 10px 22px rgba(80, 40, 120, 0.08);
  overflow: hidden;
}
